 ...
 * @author shadyside
 */
public class ViewResultByLecturer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewResultByLecturer</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewResultByLecturer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("userAccount") == null) {
            ...
            request.getRequestDispatcher("GiangVien/quanlydiem.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("userAccount") == null) {
            ...
            int lecturerID = manageLecturerDA.getLecturerByLoginID(loginID).getID();
            ...
            ArrayList<Result> lsResults = resultDA.getResultByLecturer(lecturerID, year, subjectID, classSubjectName, semester);
            request.setAttribute("lstResults", lsResults);
            request.getRequestDispatcher("GiangVien/quanlydiem.jsp").forward(request, response);
        }
    }
