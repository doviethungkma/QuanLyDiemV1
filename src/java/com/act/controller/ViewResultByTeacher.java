 ...
 * @author shadyside
 */
public class ViewResultByTeacher extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewResultByTeacher</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewResultByTeacher at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("userAccount") == null) {
            ...
            request.getRequestDispatcher("GiaoVienChuNhiem/xemdiem.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("userAccount") == null) {
            ...
            int IDGVCN = manageLecturerDA.getLecturerByLoginID(loginID).getID();
            ...
            ArrayList<Result> lsResults = resultDA.getResultByTeacher(IDGVCN, year, subjectID, className, semester);
            request.setAttribute("lstResults", lsResults);
            request.getRequestDispatcher("GiaoVienChuNhiem/xemdiem.jsp").forward(request, response);
        }
    }
