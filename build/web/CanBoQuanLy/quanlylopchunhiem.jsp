                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="col-lg-1 col-lg-offset-3">
                                            <a href="AddClassSV"><button type="submit" class="btn btn-primary">Thêm lớp học</button></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive project-stats">  
                                        <table class="table">
                                            ...
                                            <%
                                                int i = 1;
                                                ArrayList<ClassSV> lstClassSV = (ArrayList<ClassSV>) request.getAttribute("lstClassSV");
                                                ManageLecturerDA manageLecturerDA = new ManageLecturerDA();
                                                for (ClassSV classSV : lstClassSV) {
                                            ...
                                            <tr>
                                                ...
                                                <td><%= manageLecturerDA.getLecturerByLecturerID(classSV.getIDGVCN()).getLecturerName()%></td>
                                                <td>
                                                    <a href="EditClassSV?ID=<%= classSV.getID()%>"><button type="button" class="btn btn-success">Sửa</button></a>
