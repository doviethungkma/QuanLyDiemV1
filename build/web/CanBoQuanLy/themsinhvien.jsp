                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" action="AddStudent" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="txtFullName" class="form-control" id="input-Default txtFullName" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Ngày sinh</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="txtDateOfBirth" class="form-control date-picker">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Địa chỉ</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="txtAddress" class="form-control" id="input-Default">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">Tên đăng nhập</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="txtUsername" class="form-control" id="input-Default">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">Mật khẩu</label>
                                        <div class="col-sm-10">
                                            <input type="password" name="txtPassword" class="form-control" id="input-Default">
                                        </div>
                                    </div>
