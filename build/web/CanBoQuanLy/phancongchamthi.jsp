                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Phân công chấm thi</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" action="../AsignToMark" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-b-sm" name="sltLecturer" id="Lecturer">
                                                <%
                                                    ManageLecturerDA manageLecturerDA = new ManageLecturerDA();
                                                    ArrayList<Lecturer> lstAllLecturers = manageLecturerDA.getAllLecture();
                                                    for (Lecturer lecturer : lstAllLecturers) {
                                                %>
