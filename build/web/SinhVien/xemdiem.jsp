<%-- 
    Document   : xemdiem
    Created on : Sep 10, 2017, 11:38:10 AM
    Author     : shadyside
--%>
    ...
    <body class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile"><img src="../assets/images/profile-menu-image.png" width="60" alt="David Green"/><span>Nguyễn Văn C</span></div>
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name">Nguyễn Văn C<i class="fa fa-angle-down"></i></span>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span>Nguyễn Văn C<br><small>Sinh viên</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="profile.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>Xem điểm cá nhân</p></a></li>
                    </ul>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" action="ViewResultByStudent" method="POST">
                                        <div class="form-group">
                                            <label for="input-Default" class="col-lg-1 control-label">Năm học</label>
                                            <div class="col-lg-3">
                                                <div class="col-lg-10">
                                                    <select class="form-control m-b-sm" name="sltYear">
