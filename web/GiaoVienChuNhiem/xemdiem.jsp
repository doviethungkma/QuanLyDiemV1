<%-- 
    Document   : xemdiem
    Created on : Sep 10, 2017, 11:46:15 AM
    Author     : shadyside
--%>
    ...
    <body class="page-header-fixed">
        ...
        <%
            ...
            if (user == null) {
                ...
                if (roleDA.checkRole(loginID).equals("GVCN")) {
        %>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li class="active"><a href="sinhvien.jsp" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Trang chủ</p></a></li>
                        <li><a href="ViewResultByTeacher" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>Xem điểm cá nhân</p></a></li>
                    </ul>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" action="ViewResultByTeacher" method="POST">
