<%-- 
    Document   : lecturer
    Created on : Sep 10, 2017, 10:07:33 AM
    Author     : shadyside
--%>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name">Nguyễn Tuấn Anh<i class="fa fa-angle-down"></i></span>
                    ...
                    <div class="sidebar-header">
                        <div class="sidebar-profile">
                            ...
                            <div class="sidebar-profile-details">
                                <span>Nguyễn Tuấn Anh<br><small>Giảng viên</small></span>
                            </div>
                        </div>
                    </div>
